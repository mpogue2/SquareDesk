...
CONFIG_ATTRIBUTE_BOOLEAN_NO_PREFS(showArtistColumn, false);
CONFIG_ATTRIBUTE_BOOLEAN_NO_PREFS(showRatingColumn, false);
CONFIG_ATTRIBUTE_BOOLEAN_NO_PREFS(showDateAddedColumn, false);
...
CONFIG_ATTRIBUTE_STRING_NO_PREFS(numpaletteslots, "3");
...
CONFIG_ATTRIBUTE_STRING_NO_PREFS(lastNPlaylistsLoaded, "")  // comma separated list of names of the last N playlists that have been loaded
