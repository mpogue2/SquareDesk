...
// ------------------------------------------------------------
// NOTE: This file is under the Apache-2.0 license, as per
// the Github repository at https://github.com/Numerix-DSP/wav_file
// ------------------------------------------------------------

/*
EXAMPLE CODE from test_wav.c:
...
void wav_write_data_float1 (const float *, FILE *, const WAV_FILE_INFO, const int);
...
//            wav_write_word ((short)*(pData + i), FPtr);
            wav_write_word ((short)(data), FPtr);
        }
...
// FLOAT VERSION (also scales from -1,1 to -32767,32767) ===============
void wav_write_data_float1 (const float *pData,
                    FILE *FPtr,
                    const WAV_FILE_INFO WavInfo,
                    const int BufLen)
...
/**/
/********************************************************
* Function: wav_write_file_float1
*
* Parameters:
*   const float *pData,             - Output array pointer (range = -1.0 to 1.0)
*   const char *fileName,           - File name
*   const WAV_FILE_INFO WavInfo,    - WAV file info struct
*   const int BufLen
*
...
*
* Description: Write the array to a .wav file
*   Scales the input -1.0 to 1.0 to the output -32767 to 32767
*
********************************************************/
                           ...
                           const int BufLen)
{
    ...
    wav_write_header(fp, tmpWavInfo);
    wav_write_data_float1(pData, fp, tmpWavInfo, BufLen);
