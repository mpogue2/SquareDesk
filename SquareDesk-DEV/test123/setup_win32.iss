...
#define MyAppVersion "0.9.2alpha9a"
#define MyAppPublisher "Zenstar Software"
#define MyAppURL "http://www.squaredesk.net"
#define MyAppExeName "SquareDesk.exe"

; NOTE: Set this to the current test123 RELEASE directory for SquareDesk, on your system
;   All the files will be picked up directly from there, and used to build the installer.
#define DeployDirectory "Y:\clean3\SquareDesk\build-SquareDesk-Desktop_Qt_5_9_7_MSVC2015_32bit-Release\test123\release"

; NOTE: Set this to where you want the installer _SETUP.EXE file to go, after it's built
#define InstallerDirectory "Y:\clean3\Win32Installers"
...
Source: {#DeployDirectory}\imageformats\qico.dll; DestDir: "{app}\imageformats"; Flags: ignoreversion
...
Source: {#DeployDirectory}\SquareDeskManual.pdf; DestDir: "{app}"; Flags: ignoreversion
Source: {#DeployDirectory}\ssleay32.dll; DestDir: "{app}"; Flags: ignoreversion
;Source: {#DeployDirectory}\tag.dll; DestDir: "{app}"; Flags: ignoreversion  ;  this is statically linked now
