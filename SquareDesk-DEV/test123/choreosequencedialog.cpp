...
// -------------------------------------------------------------------
ChoreoSequenceDialog::ChoreoSequenceDialog(QMap<int, QString> *soundFXname, QWidget *parent) :
    QDialog(parent),
...
// ----------------------------------------------------------------
void ChoreoSequenceDialog::setFontSizes()
{
...
PushButtonColorTag::PushButtonColorTag(ChoreoSequenceDialog *prefsDialog,
...
static void addRowToTagColors(ChoreoSequenceDialog *prefsDialog, QTableWidget *tableWidget, QString tag, QString background, QString foreground)
{
...
void ChoreoSequenceDialog::on_pushButtonTagAdd_clicked()
{
...
void ChoreoSequenceDialog::on_pushButtonTagRemove_clicked()
{
    songTableReloadNeeded = true;
...
void ChoreoSequenceDialog::setTagColors( const QHash<QString,QPair<QString,QString>> &colors)
{
    songTableReloadNeeded = true;
...
void ChoreoSequenceDialog::setTagColor(const QString &tagName, const QString & /* color */, bool /* foreground */)
{
    for (int row = 0; row < ui->tableWidgetTagColors->rowCount(); ++row)
    {
...
QHash<QString,QPair<QString,QString>> ChoreoSequenceDialog::getTagColors()
{
...
QHash<QString, KeyAction *> ChoreoSequenceDialog::getHotkeys()
{
...
void ChoreoSequenceDialog::setHotkeys(QHash<QString, KeyAction *> keyActions)
{
...
void ChoreoSequenceDialog::setSessionInfoList(const QList<SessionInfo> &sessions)
{
...
QList<SessionInfo> ChoreoSequenceDialog::getSessionInfoList()
{
...
void ChoreoSequenceDialog::on_toolButtonSessionAddItem_clicked()
{
...
void ChoreoSequenceDialog::on_toolButtonSessionRemoveItem_clicked()
{
    for (int row = 0; row < ui->tableWidgetSessionsList->rowCount(); ++row)
    {
...
void ChoreoSequenceDialog::on_toolButtonSessionMoveItemDown_clicked()
{
...
void ChoreoSequenceDialog::on_toolButtonSessionMoveItemUp_clicked()
{
...
void ChoreoSequenceDialog::on_pushButtonResetHotkeysToDefaults_clicked()
{
...
void ChoreoSequenceDialog::on_comboBoxMusicFormat_currentIndexChanged(int /* currentIndex */)
{
    songTableReloadNeeded = true;
}


void ChoreoSequenceDialog::on_chooseMusicPathButton_clicked()
{
    QString dir =
...
void ChoreoSequenceDialog::on_calledColorButton_clicked()
{
...
void ChoreoSequenceDialog::on_extrasColorButton_clicked()
{
...
void ChoreoSequenceDialog::on_patterColorButton_clicked()
{
...
void ChoreoSequenceDialog::on_singingColorButton_clicked()
{
...
#define CONFIG_ATTRIBUTE_STRING(control, name, default)                 \
    QString ChoreoSequenceDialog::Get##name() const { return ui->control->text(); } \
    void ChoreoSequenceDialog::Set##name(QString value) { ui->control->setText(value); }

#define CONFIG_ATTRIBUTE_COLOR(control, name, default)                 \
    QString ChoreoSequenceDialog::Get##name() const { return ui->control->text(); } \
    void ChoreoSequenceDialog::Set##name(QString value) \
    { \
        setPushButtonColor(ui->control, value); \
    }

#define CONFIG_ATTRIBUTE_BOOLEAN(control, name, default) \
    bool ChoreoSequenceDialog::Get##name() const { return ui->control->isChecked(); } \
    void ChoreoSequenceDialog::Set##name(bool value) { ui->control->setChecked(value); }

#define CONFIG_ATTRIBUTE_COMBO(control, name, default) \
    int ChoreoSequenceDialog::Get##name() const { return ui->control->itemData(ui->control->currentIndex()).toInt(); } \
    void ChoreoSequenceDialog::Set##name(int value) \
...
#define CONFIG_ATTRIBUTE_INT(control, name, default)                 \
    int ChoreoSequenceDialog::Get##name() const { return ui->control->text().toInt(); } \
    void ChoreoSequenceDialog::Set##name(int value) { ui->control->setText(QString::number(value)); }

// Sliders are done via value() and setValue(), rather than text() and setText()
#define CONFIG_ATTRIBUTE_SLIDER(control, name, default)                 \
    int ChoreoSequenceDialog::Get##name() const { return ui->control->value(); } \
    void ChoreoSequenceDialog::Set##name(int value) { ui->control->setValue(value); }
...
void ChoreoSequenceDialog::on_initialBPMLineEdit_textChanged(const QString &arg1)
{
    int pos = 0;
...
void ChoreoSequenceDialog::on_lineEditMusicTypePatter_textChanged(const QString &arg1)
{
    Q_UNUSED(arg1)
    songTableReloadNeeded = true;  // change to folder names requires reload of the songTable
}

void ChoreoSequenceDialog::on_lineEditMusicTypeExtras_textChanged(const QString &arg1)
{
    Q_UNUSED(arg1)
    songTableReloadNeeded = true;  // change to folder names requires reload of the songTable
}

void ChoreoSequenceDialog::on_lineEditMusicTypeSinging_textChanged(const QString &arg1)
{
    Q_UNUSED(arg1)
    songTableReloadNeeded = true;  // change to folder names requires reload of the songTable
}

void ChoreoSequenceDialog::on_lineEditMusicTypeCalled_textChanged(const QString &arg1)
{
    Q_UNUSED(arg1)
    songTableReloadNeeded = true;  // change to folder names requires reload of the songTable
}
...
void ChoreoSequenceDialog::on_pushButtonTagsBackgroundColor_clicked()
{
...
void ChoreoSequenceDialog::on_pushButtonTagsForegroundColor_clicked()
{
...
void ChoreoSequenceDialog::SetLabelTagAppearanceColors()
{
...
void ChoreoSequenceDialog::on_tabWidget_currentChanged(int /* tab */)
{
...
void ChoreoSequenceDialog::finishPopulation()
{
    SetLabelTagAppearanceColors();
}

int ChoreoSequenceDialog::getActiveTab()
{
    return ui->tabWidget->currentIndex();
}

void ChoreoSequenceDialog::setActiveTab(int tabnum)
{
    ui->tabWidget->setCurrentIndex(tabnum);
}

void ChoreoSequenceDialog::on_afterLongTipAction_currentIndexChanged(int index)
{
    if (swallowSoundFX) {
        return;
    }
...
void ChoreoSequenceDialog::on_afterBreakAction_currentIndexChanged(int index)
{
    if (swallowSoundFX) {
        return;
    }
...
// Replay Gain ---------------------------------
void ChoreoSequenceDialog::on_replayGainCheckbox_toggled(bool checked)
{
    if (checked) {
...
void ChoreoSequenceDialog::on_intelCenterFreqDial_valueChanged(int value)
{
// value is in Hz/10
...
void ChoreoSequenceDialog::on_intelWidthDial_valueChanged(int value)
{
...
void ChoreoSequenceDialog::on_intelGainDial_valueChanged(int value)
{
...
void ChoreoSequenceDialog::on_intelResetButton_clicked()
{
...
void ChoreoSequenceDialog::on_intelBoostEnabledCheckbox_toggled(bool checked)
{
